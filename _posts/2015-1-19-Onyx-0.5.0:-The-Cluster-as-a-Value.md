...
If there's anything that stands out to me from Apache Storm, it's performance. You can push a screaming million messages/second through a small Storm cluster and observe linear scaling as you add more machines. Onyx will generally follow Storm's strategy of using random bit-sets, xor'ing, and in-memory acking to deliver similar performance. The goal is to be able to declare Onyx 0.6.0 truly industry-ready.
...
*My name is Michael Drogalis. I'm a developer with the LonoCloud group at ViaSat. If you'd like to get in touch, you can tweet me [@MichaelDrogalis](https://twitter.com/MichaelDrogalis) or email me at mjd3089 at rit dot edu.*
